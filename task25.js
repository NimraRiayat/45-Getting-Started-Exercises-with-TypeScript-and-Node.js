...
alien_colour == 'green' ? console.log('player has earned 5 points') : console.log("alien wasn't green");
alien_colour == 'yellow' ? console.log('player has earned 5 points') : console.log('...');
;
